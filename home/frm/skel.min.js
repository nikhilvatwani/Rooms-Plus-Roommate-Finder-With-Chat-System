...
var skel=function()
{
	...
	A="deviceType",O="newElement",M="substring",_=!0,D="cache",P="viewport",H="cacheElement",B="}",
	j="_skel_isReversed",F="head",I="vars",q="containers",R="indexOf",U="replace",z="padding-top:",
	W="matchesMedia",X="extend",V="events",$="isArray",J="onorientationchange",K="DOMReady",
	Q="skel-placeholder-breakpoint",G=":first-child>:first-child {",Y="addEventListener",Z="getComputedStyle",
	et="^head",tt="padding:",nt="{display:none!important}",rt="registerLocation",it="hasOwnProperty",st="defaults",
	
	ot="IEVersion",ut="documentElement",at="attachElements",ft="horizontal",lt="attachElement",
	ct="DOMContentLoaded",ht="text/css",pt="change",dt="states",vt="_skel_attach",mt="firstChild",
	gt=":first-child>*{",yt="initial-scale=1",bt="removeEventListener",wt="placeholder",
	Et=">*{",St="(min-width: ",xt="applyRowTransforms",Tt="resize",Nt=".row.uniform",
	Ct="attached",kt=".row",Lt="vertical",At="media",Ot="forceDefaultState",Mt="html",_t="nextSibling",
	Dt="collapse",Pt="_skel_placeholder",Ht="querySelectorAll",Bt="max-height",jt="min-height",
	Ft="prototype",It="min-width",qt="max-width",Rt="innerHTML",Ut="domready",zt="href",
	Wt=".\\3$1 ",Xt="isStatic",Vt="priority",$t="readyState",Jt="onresize",Kt="android",
	Qt={breakpoints:[],breakpointList:[],cache:{elements:{},states:{},stateElements:{}},
	config:{breakpoints:{"skel-placeholder-breakpoint":{href:u,media:""}},
	containers:960,defaultState:c,events:{},grid:{collapse:u,gutters:{vertical:40,horizontal:0}},
	
	pollOnce:u,preload:u,reset:u,RTL:u,viewport:{width:"device-width"}},
	css:{bm:"*,*:before,*:after{-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}",
